...
class VenueForm(Form):
    ...
    city = StringField(
        label='city', validators=[DataRequired()]
    )
    state = SelectField(
        label='state', validators=[DataRequired()],
        choices=[
            ('AL', 'AL'),
            ('AK', 'AK'),
            ('AZ', 'AZ'),
    ...
    address = StringField(
        label='address', validators=[DataRequired()]
    )
    phone = StringField(label='phone')
    image_link = StringField(label='image_link')
    genres = SelectMultipleField(
        label='genres', validators=[DataRequired()],
        choices=[
    ...
    facebook_link = StringField(
        label='facebook_link', validators=[URL()]
    )
